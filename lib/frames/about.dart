            ...
            SingleChildScrollView(
              child: Center(
                child: Container(
                  ...
                  child: const Column(children: [Image(image: AssetImage('assets/images/image_11.png')), SizedBox(height: 50), Text(
                    ...
                    style: TextStyle(fontSize: 15), // Ajustar el tamaño de la fuente aquí
                  ),],)
                ),
              ),
            ),

                    ...
                    children: [
                      ...
                      ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          padding:
                              EdgeInsets.all(40), // Ajusta el tamaño del botón
                      ...
                      ElevatedButton(
                        ...
                        child: Text('Tipos de esculturas', style: TextStyle(fontSize: 24),),
                      ),
                    ],
                  ),
                  SizedBox(width: 50),
                  Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        child: Text('Materiales', style: TextStyle(fontSize: 24),),
                      ),
                      SizedBox(
                        height: 30,
                      ),
                      ElevatedButton(
                        ...
                        child: Text('Técnicas',style: TextStyle(fontSize: 24),),
                      ),
                      SizedBox(
                        height: 30,
                      ),
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => const InformacionPage(
                                ...
                                contenido: 'Contenido de la información 1',
                              ),
                            ),
                          );
                        },
                        child: Text('La escultura en Las Tunas',style: TextStyle(fontSize: 24),),
                      ),
                      SizedBox(height: 20,)
                    ],
                  ),
